          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-glass backdrop-blur-xl">
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              {projects.map((project) => (
                ...
                >
                  <div className="overflow-hidden rounded-3xl bg-slate-800 inline-flex justify-center">
                    <img src={import.meta.env.BASE_URL + 'cloud-s5-screenshot.png'} alt="Cloud S5 - Gestion des travaux routiers" className="max-w-full h-auto object-contain" />
                  </div>
